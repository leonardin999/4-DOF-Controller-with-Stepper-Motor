 function [ IK ] = IKSolve( L1,L2,Lep,Tx,Ty,Tz )
 % Denavit-Hartenberg's Parameters
 
      %syms L1  L2 Lep Tx Ty Tz
    %  syms Thelta1   Thelta2   Thelta3
 %% Solutions
  Thelta1 = atan2(Ty ,Tx);
             
  a = Tz - L1;
  b = Tx/cos(Thelta1);
  p2 = (Tx/cos(Thelta1))^2 + (Tz - L1)^2;
...
% DH = [ 0                0            L1           Thelta1;...  %frame1
%       -pi/2             0             0           Thelta2;...  %frame2
%        0                L2            0           Thelta3;...  %frame3 
%        0                Lep           0             0]         %End-point
% 
